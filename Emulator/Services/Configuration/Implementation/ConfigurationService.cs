...
using System.Xaml;
using System.Xml;
using Emulator.Services.Configuration.Implementation.Serialization;
...
namespace Emulator.Services.Configuration.Implementation
{
    ...
    {
        private const string DefaultConfigResourceName = "Emulator.Services.Configuration.Implementation.DefaultConfig.xml";
        ...
        public void Save()
        {
            ...
            using (FileStream stream = File.Open(this.ConfigurationFileName, FileMode.Truncate, FileAccess.Write))
